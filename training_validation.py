...
modeling = models.mobilenet_v3_small(pretrained=True)
cuda_name = "cuda:0"
if len(sys.argv)>3:
...
for dataset in datasets:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        best_test_ci = 0
        best_epoch = -1
        model_file_name = 'model_' + modeling + '_' + dataset +  '.model'
        result_file_name = 'result_' + modeling + '_' + dataset +  '.csv'
